...
if __name__ == '__main__':
    ...
    fin1.to_csv("RAW_top_artists_b6_17.csv", sep='\t')
    fin2.to_csv("RAW_top_artists_b18_21.csv", sep='\t')
    fin3.to_csv("RAW_top_artists_b22_25.csv", sep='\t')
    fin4.to_csv("RAW_top_artists_b26_30.csv", sep='\t')
    fin5.to_csv("RAW_top_artists_b31_40.csv", sep='\t')
    fin6.to_csv("RAW_top_artists_b41_50.csv", sep='\t')
    fin7.to_csv("RAW_top_artists_b51_60.csv", sep='\t')
    fin8.to_csv("RAW_top_artists_b61_100.csv", sep='\t')
